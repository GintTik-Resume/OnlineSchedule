...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineSchedule.Data.Entities.Lesson", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnlineSchedule.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OnlineSchedule.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineSchedule.Data.Entities.Lesson", b =>
                {
                    b.HasOne("OnlineSchedule.Data.Entities.Day", "Day")
                        .WithMany("Lessons")
                        .HasForeignKey("DayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
